        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 d-flex flex-column align-items-center text-center">
                ...
                <div class="section-text fs-18 text-dark-gray mt-3 mb-3">
                    <span class="fw-600">Lorem Ipsum
                </div>
            </div>
            
            <!-- Kata Sambutan (Full-width) -->
            <div class="col-12">
                <p class="section-text text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis iure ullam dolore quos provident, eveniet blanditiis dolorem quibusdam dicta dolorum alias corporis dolor est voluptatibus ea magni ipsa distinctio? Repellat.</p>
